package com.example.emt2_lab.port.rest;

import com.example.emt2_lab.infra.eventlog.DomainEventLogService;
...
public class EventLogController {
    ...
    public ResponseEntity<List<StoredDomainEvent>> domainEvents(@PathVariable("lastProcessedId") Long lastProcessedId) {
        ...
        return responseBuilder.body(this.domainEventLogService.retrieveLog(lastProcessedId));
    }
}
